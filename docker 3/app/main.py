...
@app.get('/uses', name='Uses', tags=['QCM'])
...
@app.get('/subjects', name='Subjects', tags=['QCM'])
...
@app.get('/questions', name='Questions', tags=['QCM'])
